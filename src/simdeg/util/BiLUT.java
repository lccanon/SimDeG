 ...
 */
public class BiLUT<E1 extends Number, E2 extends Number, R> extends LUT {
    ...
    /** First range */
    private BigDecimal[] range1 = null;

    /** First range */
    private BigDecimal[] range2 = null;
     ...
     */
    @SuppressWarnings("unchecked")
    private R computeValue(E1 x, E2 y) {
        try {
